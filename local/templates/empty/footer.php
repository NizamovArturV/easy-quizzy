...
<footer class="footer" role="contentinfo" style="background-image: url('<?=SITE_TEMPLATE_PATH?>/build/images/footer-bg.jpg');">
        ...
        <div class="footer__inner">
            ...
            <div class="footer__side">
                ...
                <div class="footer__links">
                    <a href="tel:+79872334116" class="footer__link">+7 (987) 233-41-16</a>
                    <a href="mailto:easy@quizzy.ru" class="footer__link footer__link--yellow">easy@quizzy.ru</a>
                </div>
            </div>
        </div>
    </div>
    <div class="footer__bottom">
        <div class="footer__inner">
            ...
            <p class="footer__text">2019 © Easy Quizzy | Политика конфиденциальности</p>
...
<script src="<?=SITE_TEMPLATE_PATH?>/build/main.js"></script>
